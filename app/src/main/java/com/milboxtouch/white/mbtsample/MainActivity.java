package com.milboxtouch.white.mbtsample;
...
import com.milboxtouch.white.milboxtouch_sdk.MilboxView;
...
public class MainActivity extends GvrActivity implements GvrView.StereoRenderer  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MilboxView milboxView = (MilboxView)findViewById(R.id.milbox_target);
        milboxView.addOnTapListener(new Function0<Void>() {
            @Override
            public Void invoke() {
                Log.e(TAG,"tap!");
                return null;
